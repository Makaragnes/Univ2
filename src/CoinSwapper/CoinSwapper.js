...
function CoinSwapper(props) {
  ...
  const [router, setRouter] = React.useState(
    getRouter("0x5cBF27c7a1b871D5268Bd2a627674bC605B4EBAC", signer)
  );
  const [weth, setWeth] = React.useState(
    getWeth("0xd9145CCE52D386f254917e481eB44e9943F39138", signer)
  );
  const [factory, setFactory] = React.useState(
    getFactory("0xbE1E21e5a7edb999a473C1004F5e67BD70ffdEE3", signer)
  );
